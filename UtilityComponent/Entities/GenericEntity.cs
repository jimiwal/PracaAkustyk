...
namespace UtilityComponent.Entities
{
    ...
    [Serializable]
    public abstract class GenericEntity<TId> : ValidatableObject, IGenericEntity<TId>
    {
        /// <summary>
        /// Id of the entity (identity)
        /// </summary>
        [DomainSignature]
        public virtual TId Id { get; set; }

        /// <summary>
        /// Version number of the Entity, used for concurrency control.
        /// </summary>
        ...
        /// a LogDefinition is transient if its Id is 0.  
        /// </summary>
